...
4. **Audio model ranking:** HuBERT >> WavLM > Wav2Vec2
...
5. **HuBERT >> WavLM as audio partner** — DINOv2+WavLM (0.6947) is 2.8pp below DINOv2+HuBERT (0.7223)
...
### HuBERT >> WavLM as Audio Partner

| Audio Model | With DINOv2 (≥10) | With DINOv2 (≥8) | With DINOv2 (≥5) |
|-------------|--------------------|--------------------|-------------------|
| **HuBERT** | **0.7223** | **0.7167** | **0.6331** |
| WavLM | 0.6947 | 0.6902 | 0.6068 |
| Δ | +0.0276 | +0.0265 | +0.0263 |

HuBERT consistently outperforms WavLM by ~2.7pp as a fusion partner.
...
- **Best single-modality:** HuBERT SVM-RBF = **0.6870**
- **Best image model:** DINOv2 SVM-RBF = **0.6810**
